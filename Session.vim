...
badd +12 ~/AppData/Local/nvim/lua/plugins/persistence.lua
badd +44 ~/AppData/Local/nvim/init.lua
argglobal
%argdel
$argadd .
edit ~/AppData/Local/nvim/lua/plugins/persistence.lua
...
25
normal! zo
let s:l = 44 - ((16 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 44
